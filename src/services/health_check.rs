...
impl HealthCheckManager {
    ...
    /// Get the healthiest service (always returns normal RPC)
    pub fn get_healthiest_service() -> Option<String> {
        // Always use normal RPC since TransactionLandingMode is removed
    ...
    pub async fn wait_for_service_health(service_name: &str, _timeout_secs: u64) -> bool {
        Self::is_service_healthy(service_name)
    }
} 